...
export const BAIT_CATALOG: { [key: string]: BaitDefinition } = {
    ...
    'bug_roll': {
        ...
        rarity: 'rare',
        class: 'Basic',
        description: 'Crafted bait that boosts rod strength and general catch rate.',
        harvestChance: 0.33,
        minHarvestAmount: 1,
        maxHarvestAmount: 1,
        value: 12,
    ...
    'shrimp_roll': {
        ...
        value: 12,
        baseLuck: 1.10,
        targetSpecies: ['Tuna', 'Grouper', 'Salmon'],
        speciesLuck: {
            'grouper': 1.95,
            'tuna': 1.95,
            'salmon': 1.95,
    ...
    'squid_roll': {
        ...
        targetSpecies: ['Sharks'],
        speciesLuck: {
            'great_white_shark': 1.6,
            'hammerhead_shark': 1.9,
        },
        resilliance: 1.05,
        strength: 1.10,
    },
    ...
    'chum_roll': {
        ...
        rarity: 'rare',
        class: 'Specialized',
        description: 'Crafted bait for a variety of deep sea fish.',
        harvestChance: 0.33,
        minHarvestAmount: 1,
        maxHarvestAmount: 1,
        value: 12,
